...
from .domain import DomainCubicPartition
...
class FBPINN(nn.Module):
    ...
    def __init__(self, domain, networks,
        ...
        self._active_mask = torch.zeros(self.n_subdomains, dtype=torch.bool, device=device)
        self._active_mask[self._active_indices] = True
        self.register_buffer('active_mask', self._active_mask)
