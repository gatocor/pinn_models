...
class Lifting:
    ...
    Apply as the **last** layer in a :class:`~pinns.modelbase.ModelBase` pipeline.
    ...
    :meth:`~pinns.modelbase.ModelBase.apply` injects automatically as
    ``params_dict['_x_orig']``.
    ...
    Example::
        ...
        net = ModelBase(domain, output_dim=2)
        net.add(Normalize())
        net.add(FNN([128, 128]))
    ...
    def _configure(self, network, input_dim: int) -> int:
        ...
        Called automatically by :meth:`~pinns.modelbase.ModelBase.add`.
    ...
    def apply(
        ...
        params_dict : dict or None
            ...
            ``(batch, n_dims)`` injected by :meth:`~pinns.modelbase.ModelBase.apply`.
